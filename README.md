...
The fourth part Part4-GeneratingMusic with 5 outputs.ipynb contains the music generation, post processing and music which can be played directly using the inline player.
